...
otn_files <- otn_imos_column_map(qc_data)

otn_files <- list(det = "/Users/bruce/Downloads/nsbs_matched_detections_2021/nsbs_matched_detections_2021.csv")

#tag_qc <- runQC(files, .parallel = FALSE, .progress = FALSE)
tag_qc <- runQC(otn_files, data_forma = "otn", .parallel = FALSE, .progress = TRUE)
```
