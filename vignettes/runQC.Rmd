...
The `dQC` object can form the basis for subsequent annotation with environmental data (see `extractENV()`; [extractENV-vignette](extractENV.html); and `extractMoor()`; [extractMoor-vignette](extractMoor.html)) and analysis.  
