...
The `dQC` object can form the basis for subsequent annotation with environmental data (see `extractENV()`; [link to Vinays vignette](); and `mooringTable()`; [link to Ross and Kylies vignette]()) and analysis.  
